...
class TestWeftReader(unittest.TestCase):
    def setUp(self):
        ...
        multi_year = MultiYearBlock(
            start_year=2000, duration=10, coeffs=[1.0, 0.5, -0.2]
        )
        weft_file = WeftFile(
        ...
        monthly1 = MonthlyBlock(
            year=2022, month=1, day_count=31, coeffs=[0.1, 0.2, 0.3]
        )
        monthly2 = MonthlyBlock(
            year=2022, month=2, day_count=28, coeffs=[0.4, 0.5, 0.6]
        )
        weft_file = WeftFile(
        ...
        daily1 = DailyDataBlock(
            year=2023, month=6, day=1, coeffs=[0.3, 0.4, 0.5], block_size=block_size
        )
        daily2 = DailyDataBlock(
            year=2023, month=6, day=2, coeffs=[0.6, 0.7, 0.8], block_size=block_size
        )
        daily3 = DailyDataBlock(
            year=2023, month=6, day=3, coeffs=[0.9, 1.0, 1.1], block_size=block_size
        )
        weft_file = WeftFile(
        ...
        multi_year = MultiYearBlock(
            start_year=2020, duration=5, coeffs=[1.0, 0.5, -0.2]
        )
        ...
        daily1 = DailyDataBlock(
            year=2022, month=6, day=15, coeffs=[0.3, 0.4, 0.5], block_size=block_size
        )
        daily2 = DailyDataBlock(
            year=2022, month=6, day=16, coeffs=[0.6, 0.7, 0.8], block_size=block_size
        )
        weft_file = WeftFile(
        ...
        daily1 = DailyDataBlock(
            year=2023, month=7, day=1, coeffs=[10.0, 0.0, 0.0], block_size=block_size
        )
        # July 2 block - covers July 2 00:00 to July 3 00:00
        daily2 = DailyDataBlock(
            year=2023, month=7, day=2, coeffs=[20.0, 0.0, 0.0], block_size=block_size
        )
        # July 3 block - covers July 3 00:00 to July 4 00:00
        daily3 = DailyDataBlock(
            year=2023, month=7, day=3, coeffs=[30.0, 0.0, 0.0], block_size=block_size
        )
        weft_file = WeftFile(
    ...
    def test_linear_interpolation(self):
        ...
        self.assertGreater(
            value2, (july1_value + july2_value) / 2
        )  # Should be weighted toward July 2
