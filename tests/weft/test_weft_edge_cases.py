...
class TestWeftEdgeCases(unittest.TestCase):
    ...
    def test_missing_block_markers(self):
        ...
        with open(file_path, "wb") as f:
            f.write(b"#weft! v0.02 test jpl:test 2000s 32bit test chebychevs generated@test\n")
    ...
    def test_incorrect_block_sizes(self):
        ...
        header = DailySectionHeader(
            ...
            end_year=2023, end_month=1, end_day=2,
    ...
    def test_leap_year_handling(self):
        ...
        feb_2020 = MonthlyBlock(year=2020, month=2, day_count=29, coeffs=[1.0])  # Leap year
        feb_2021 = MonthlyBlock(year=2021, month=2, day_count=28, coeffs=[1.0])  # Non-leap year
        weft_file = WeftFile(
    ...
    def test_timezone_handling(self):
        ...
        header = DailySectionHeader(
            ...
            block_size=block_size, block_count=1
        )
        block = DailyDataBlock(
            year=2023, month=1, day=1,
            coeffs=[1.0, 0.0, 0.0],
